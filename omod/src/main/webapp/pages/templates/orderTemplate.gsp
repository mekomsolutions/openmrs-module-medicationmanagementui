<div>
	...
	<span ng-controller="MMUIDispenseConfigInitializer">
		...
		<table  style="border-bottom: 3px solid #00463f;">
			<tr title="Click to get more details" style="height:40px">
				<td ng-click="showDetails=!showDetails" >
					...
					<mmui-dispense-tag order="order" orderConfig="config" dispenseConfig="dispenseConfig"></mmui-dispense-tag>
		...
		<span ng-if="config.quantityUnits">
			<mmui-dispense order="order"  orderConfig="config" dispenseConfig="dispenseConfig" ng-show="toDispense"></mmui-dispense>
		</span>
	</span>
</div>